    ...
    fetch(`${API_BASE_URL}/auth/me`, {
      ...
      .then((data) => {
        ...
        if (data?.user) {
          ...
          if (data.user.hasAssignedProject) {
            setState((prev) => ({
              ...prev,
              isAssigned: true,
              assignedTaskId: data.user.assignedProjectId,
            }));
          }

          if (data.user.hasSubmittedProject) {
            setState((prev) => ({
              ...prev,
              hasSubmitted: true,
            }));
            setRepoUrl(data.user.githubRepoUrl || "");
          }
        }
        setIsLoading(false);
      })
    ...
    <>
      {isLoading && (
        <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-background">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          {!state.isAssigned ? (
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm sm:text-base text-muted-foreground">
                        <li className="flex gap-3 items-start">
                          ...
                          <span>
                            <strong>Random Assignment:</strong> Your project
                            will be randomly selected from the pool you choose
                          </span>
                        </li>
                        <li className="flex gap-3 items-start">
                          <span className="text-primary font-semibold flex-shrink-0">
                          ...
                          <span>
                            <strong>Email Delivery:</strong> All project details
                        ...
                        <li className="flex gap-3 items-start">
                          ...
                          <span>
                            <strong>One-Time Only:</strong> You can only assign
                            a task once. Choose carefully!
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="mb-8 sm:mb-10">
                <div className="bg-card rounded-2xl shadow-soft-lg p-6 sm:p-8">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Select a number to receive a randomly assigned project. The
                    number you choose will determine which project you get.
                  </p>
                </div>
              </div>
            ...
            <>
              ...
              <div className="mb-8 sm:mb-12">
                <div className="bg-accent/5 border border-accent/30 rounded-2xl p-6 sm:p-10 text-center">
                  ...
                  <p className="text-muted-foreground text-sm sm:text-base">
                    Check your email ({user.email}) for full project details and
                    instructions.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mb-4 sm:mb-6">
                      Reassignment is not allowed. Each student can only receive
                      one task assignment per workshop session.
                    </p>
              ...
              {!state.hasSubmitted ? (
                <div className="mt-10 bg-card rounded-2xl shadow-soft-lg p-6 sm:p-8 mb-10">
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-4">
                    Submit Your GitHub Repository
                  </h3>

                  <p className="text-sm text-muted-foreground mb-6">
                    Once completed, submit your GitHub repository link below.
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="px-8 py-3 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 disabled:opacity-50"
                    >
                      Submit
                    </button>
                  </div>
                ...
                <div className=" mt-10 bg-secondary/30 border border-border rounded-xl p-6 sm:p-8 mb-10">
